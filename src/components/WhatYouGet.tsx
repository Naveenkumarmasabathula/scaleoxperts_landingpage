...
const WhatYouGet: React.FC = () => {
  ...
  return (
    <div className="bg-[#fffaf4] text-black py-6 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
          WHAT YOU GET IN OUR <br />
          <span className="text-orange-500">FREE DIGITAL MARKETING AUDIT</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-[#fffaf4] text-black  rounded-2xl flex items-center justify-center">
        ...
        <div className="bg-gradient-to-r from-green-500 to-blue-600 p-8 rounded-2xl text-white text-center">
          ...
          >
            <Calendar className="w-16 h-16 sm:w-6 sm:h-6" />
      ...
      {/* Glow behind person */}
      <div className="absolute w-64 h-64 bg-orange-300 blur-3xl opacity-40 rounded-full" />

      {/* Person image */}
      <Image
        src="/belowbook_myfreeaudit.webp"
        alt="Person showing tools and apps"
        width={400}
        height={400}
