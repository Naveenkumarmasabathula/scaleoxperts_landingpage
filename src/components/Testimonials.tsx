...
const Testimonials: React.FC = () => {
  ...
  const handleWhatsAppClick = () => {
    window.open(
      'https://wa.me/+919999999999?text=I saw the testimonials and want to claim my free audit like other successful businesses!',
      '_blank'
    );
  };
    ...
    <div className="bg-[#fffaf4] text-black py-16 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">Real reviews from our satisfied clients</p>
        </div>
